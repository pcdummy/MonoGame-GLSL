...
namespace BilLODTerrain
{
    ...
    public struct TerrainPrimitive
    {
       ...
       /* internal TerrainPrimitive()
		...
		public Microsoft.Xna.Framework.Plane GetPlane(List<Microsoft.Xna.Framework.Graphics.VertexPositionNormalTexture> vertices)
        {
		...
		public Microsoft.Xna.Framework.Vector3 GetNormal(List<Microsoft.Xna.Framework.Graphics.VertexPositionNormalTexture> vertices)
        {
		...
		public void SetNormal(List<Microsoft.Xna.Framework.Graphics.VertexPositionNormalTexture> vertices)
        {
